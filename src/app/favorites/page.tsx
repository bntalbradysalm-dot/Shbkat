...
import { Wifi, MapPin, Heart, Search, X, AlertCircle, Database, Calendar, CheckCircle, Copy, MessageSquare, Wallet } from 'lucide-react';
...
export default function FavoritesPage() {
  ...
  return (
    <>
      ...
      {/* Details Popup (Same as ServicesPage) */}
