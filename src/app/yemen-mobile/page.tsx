      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <Card className="shadow-lg border-none rounded-[32px] overflow-hidden bg-white">
          ...
          <CardContent className="p-6 space-y-6">
            <div className='space-y-2'>
              <Label htmlFor="phone" className="text-xs font-bold text-muted-foreground px-1 text-right block">
                ادخل رقم الهاتف
              </Label>
              <Input
                id="phone"
                           ...
                           <div className='space-y-4'>
                                <div className='space-y-2'>
                                    ...
                                    <Input 
                                        ...
                                        className="text-center font-black text-3xl h-16 rounded-2xl bg-muted/20 border-2 px-4" 
                                    />
                                </div>
                                <div className="space-y-2">
